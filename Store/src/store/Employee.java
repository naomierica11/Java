...
public interface Employee {
     ...
     *
     * @return - This method returns the name of the employee.
     */
    String getEmployeeName();

    /**
     * This method represents a new abstract action for the employee.
     *
     * @param hoursWorked - The number of hours the employee worked.
     * @return - This method returns some result based on the hours worked.
     */
    int performNewEmployeeAction(int hoursWorked);
