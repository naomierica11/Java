...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // Declare and initialize a List object of type SecurityGuard as "securityGuardList", and initialize the object as an ArrayList.
        List<SecurityGuard> securityGuardList = new ArrayList<SecurityGuard>();
        ...
        while (sc.hasNext()) {
            ...
            //    and read the data. 
            if (employeeType.equals("SecurityGuard")) {
                // Read the specific attribute for SecurityGuard (nightShift) and create a SecurityGuard object
                boolean nightShift = sc.nextBoolean();
                SecurityGuard securityGuard = new SecurityGuard(numberOfHoursWorked, hourlyRate, storeDetails, basePay, empName, nightShift);
        ...
        for (Manager manager : managerList) {
            ...
            System.out.println("Performance rating = "+ manager.calculatePerformanceRating());
            System.out.println("Manager New Employee Action Result: " + manager.performNewEmployeeAction(40)+"\n");
        ...
        for (SalesAssociate salesAssociate : SalesAssociateList) {
            ...
            System.out.println("Performance rating = "+ salesAssociate.calculatePerformanceRating());
            System.out.println("Sales Associate New Store Action Result: " + salesAssociate.performNewStoreAction(50)+"\n");

            // While loop ends here
            // Print the size of the securityGuardList to the console and outputfile.
            System.out.println("******************************************************");
            ...
            // Use an enhanced for loop and iterate through securityGuardList which is of type SecurityGuard.
            // Increment the count of the securityGuardCount by one every time the loop is started.
            // Test the toString(), calculatePay(), and checkPromotionEligibility() methods of the SecurityGuard class and write the output to both console and output file.
            for (SecurityGuard securityGuard : securityGuardList) {
                ...
                System.out.println("Performance rating = "+ securityGuard.calculatePerformanceRating());
                System.out.println("Security Guard New Store Action Result: " + securityGuard.performNewStoreAction(30)+"\n");
            }
