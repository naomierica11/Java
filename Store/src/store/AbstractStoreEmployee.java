...
public abstract class AbstractStoreEmployee implements Employee, Store {
    ...
    /**
     * Abstract method to calculate performance rating.
     * This method represents performance measurement specific to each type of employee.
     *
     * @return The performance rating.
     */
    public abstract int calculatePerformanceRating();
